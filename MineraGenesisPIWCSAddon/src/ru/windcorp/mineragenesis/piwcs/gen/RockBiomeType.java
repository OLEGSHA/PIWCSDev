...
public class RockBiomeType {
	
	private final DiscreteNoise<RockBiome> biomes;

	public RockBiomeType(DiscreteNoise<RockBiome> biomes) {
		this.biomes = biomes;
	}

	public DiscreteNoise<RockBiome> getBiomes() {
		return biomes;
	}
