 ...
 *
 */
public class BedrockOreRenderer extends Renderer {
	 ...
	 * @param dim
	 */
	public BedrockOreRenderer(DimensionComplex dim) {
		super(dim);
	...
	public int getColorAt(double x, double z) {
		RockBiome rb = ((DimensionComplex) getDimension()).getBedrock().get(Math.floor(x / 16), Math.floor(z / 16));
	...
	public String toString() {
		return "Bedrock ores of " + getDimension();
	}
